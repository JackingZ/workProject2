<template>
  <!-- eslint-disable -->
  <div class="el-tree-node" @click.stop="handleClick" @contextmenu="($event) => this.handleContextMenu($event)" v-show="node.visible" :class="{
    ...
    <el-collapse-transition>
      <div class="el-tree-node__children" v-if="!renderAfterExpand || childNodeRendered" v-show="expanded" role="group" :aria-expanded="expanded">
        <el-tree-node v-for="child in node.childNodes" :key="getNodeKey(child)" :node="child" @node-expand="handleChildNodeExpand">
        </el-tree-node>
      </div>
    </el-collapse-transition>
  </div>
...
/* eslint-disable */
import ElCollapseTransition from '@/components/ElTreeSelectLib/transitions/collapse-transition'
import ElCheckbox from '@/components/ElTreeSelectLib/checkbox'
import NodeContent from '@/components/ElTreeSelectLib/tree/src/basic/node-content'
import emitter from '@/components/ElTreeSelectLib/mixins/emitter'
import { getNodeKey } from '@/components/ElTreeSelectLib/tree/src/model/util'
