<template>
  <div style="display: flex;flex-flow: row nowrap;min-height: inherit;">
    ...
    >
      <div
        v-show="!detailShow && !expressShow && !orderTrackingShow"
        v-loading="loading"
        class="app-container"
      >
        <head-info
          ...
          <div style="display: flex;flex-flow: row nowrap;">
            ...
            <div style="flex: 1;padding: 4px 0 0 28px;">
              ...
              >
                ...
                >
                  <img
                    src="@/assets/imgs/yiqianshou.png"
                    class="img-icon"
                  >
                  <div class="img-word">
                    <span class="img-number">{{ statisForm.receiverCount }}</span>
                    <br>
                    <span class="img-text">已签收</span>
                  </div>
                </el-col>
                <el-col
                  :span="3"
                ...
                >
                  ...
                  >
                  <div class="img-word">
                    <span class="img-number">{{ statisForm.billNotPaidCount }}</span>
                    <br>
                    <span class="img-text">未出账单</span>
                  </div>
                </el-col>
                <el-col
                  :span="3"
                ...
                >
                  ...
                  >
                  <div class="img-word">
                    <span class="img-number">{{ statisForm.abnormalCount }}</span>
                    <br>
                    <span class="img-text">财务异常</span>
                  </div>
                </el-col>
              </el-row>
            </div>
...
import searchMore from '@/views/financial-management/order/searchMore.vue'
import detail from '@/views/financial-management/order/detail.vue'
...
export default class extends Vue {
  ...
  private handleOrder(str: any) {
    //
  }
  private handleView(row: any) {
    this.detailShow = true
    const root: any = this.$refs.details
    root.setData(row)
  }
  private handleVague() {
