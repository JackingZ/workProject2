<template>
  ...
  >
    ...
    >
      <el-link
        v-permission="['trailerOrderFinancialAdd']"
        :underline="false"
        style="float: left"
        type="primary"
        @click="addInvoice"
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            <el-button
              v-if="itemV.status !== '1' && !itemV.isEdit && $checkPermission(['trailerOrderFinancialAudit'])"
              type="text"
            ...
            <el-button
              v-if="!itemV.isEdit && !itemV.isAdd && itemV.ifVerify === 0 && itemV.status !== '3' && $checkPermission(['trailerOrderFinancialEdit'])"
              type="text"
...
export default class extends Vue {
  ...
  private getInvoiceItem() {
    const invoice: any = {
      ...
      orderCode: this.rowDetail.soCodes[0],
