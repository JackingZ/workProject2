...
export default class extends Vue {
  ...
  // 显示弹窗
  private showModel(selectService: any, selectList: any[], title?: string, params?: any) {
  ...
  private save() {
    ...
    this.$emit('save', this.relevanceList, this.relevanceList.map((it: any) => this.list.find((e: any) => e.id === it)))
    this.dialogClose()
  }
