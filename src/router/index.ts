...
import LayoutFile from '@/layout-file/index.vue'
...
// import productManagementRouter from './modules/product-management'
// import businessManagement from './modules/business-management'
import organizersManagementRouter from './modules/organizers-management'
import operationManagementRouter from './modules/operation-management'
import systemManagementRouter from './modules/system-management'
import businessConfigurationRouter from './modules/business-configuration'
import operatingCostRouter from './modules/operating-cost'
import warehouseManagementRouter from './modules/warehouse-management'
import serviceConfigurationRouter from './modules/service-configuration'
import orderlistManagementRouter from './modules/orderlist-management'
import financialManagementRouter from './modules/financial-management'
import priceManagementRouter from './modules/price-management'
import salesManagementRouter from './modules/sales-management'
// import customerManagementRouter from './modules/customer-management'
// import systemManagementRouter from './modules/system-management'
// import settlementManagementRouter from './modules/settlement-management'
// import ReportManagementRouter from './modules/report-management'
...
export const constantRoutes: RouteConfig[] = [
  ...
  },
  {
    path: '/kanban',
    component: () =>
      import(/* webpackChunkName: "login" */ '@/views/kanban/index.vue'),
    meta: { hidden: true }
  },
  {
    path: '/data-monitor',
    component: () =>
      import(/* webpackChunkName: "login" */ '@/views/data-monitor/index.vue'),
    meta: { hidden: true }
  },
  {
    path: '/monitor-detail',
    component: () =>
      import(/* webpackChunkName: "login" */ '@/views/data-monitor/detail.vue'),
    meta: { hidden: true }
  },
  {
    path: '/auth-redirect',
...
export const asyncRoutes: RouteConfig[] = [
  ...
  serviceConfigurationRouter,
  orderlistManagementRouter,
