        ...
        <div class="app-panel">
          ...
          >
            ...
            >
              <template slot-scope="scope">
                <el-button
                  v-if="scope.row.status !== 3 && $checkPermission(['waiterListUpdate'])"
                  type="text"
                ...
                <el-button
                  v-if="scope.row.status !== 1 && $checkPermission(['waiterListDel'])"
                  type="text"
                ...
                <el-button
                  v-if="scope.row.status !== 1 && $checkPermission(['waiterListAudit'])"
                  type="text"
...
import detail from '@/views/financial-management/cash-order/detail.vue'
import {
  getRequestList,
  deleteRequest,
